...
.con1{ width:1024px; height:710px; margin:0 auto; position:relative}
    .con1bg{ background:url(<?php echo cqtheme160301_get_path() ?>/img/bg-1.png) no-repeat center center #2e313a}
...
.con3bg{ background:url(<?php echo cqtheme160301_get_path() ?>/img/c3bg.png) no-repeat center center #f1f2f6}
...
.con5bg{ background:url(<?php echo cqtheme160301_get_path() ?>/img/c3bg.png) no-repeat center center #f1f2f6}
  ...
  <script>
    jQuery(function() {
      jQuery(".c33div").mouseover(function(){
        ...
        index++;
        jQuery(this).find(".c33divimg").attr("src","<?php echo cqtheme160301_get_path() ?>/img/3-" + index + "-h.png" );
      });
      jQuery(".c33div").mouseout(function(){
        var index = jQuery(this).index(".c33div");
        index++;
        jQuery(this).find(".c33divimg").attr("src","<?php echo cqtheme160301_get_path() ?>/img/3-" + index + "-n.png" );
      });

      jQuery(".c62div").mouseover(function(){
        var index = jQuery(this).index(".c62div");
        index++;
        jQuery(this).find(".c62img").attr("src","<?php echo cqtheme160301_get_path() ?>/img/6-" + index + "-h.png" );
      });
      jQuery(".c62div").mouseout(function(){
        var index = jQuery(this).index(".c62div");
        index++;
        jQuery(this).find(".c62img").attr("src","<?php echo cqtheme160301_get_path() ?>/img/6-" + index + "-n.png" );
      });
